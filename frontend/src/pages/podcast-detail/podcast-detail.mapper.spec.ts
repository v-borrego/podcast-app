...
describe("Podcast detail mappers tests", () => {
  it("should map podcast model from ApiModel to ViewModel", () => {
    // Arrange
    const podcastApiModel: ApiModel.PodcastDetail = podcastDetailResponse;
...
const podcastDetailResponse: ApiModel.PodcastDetail = {
